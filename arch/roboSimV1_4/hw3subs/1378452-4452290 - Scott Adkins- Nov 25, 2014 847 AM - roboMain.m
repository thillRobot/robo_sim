...
elseif map_opt==3 %load a map from a text file
    ...
    obsy=[   11.405530 84.769585 39.423963 10.668203 
             142.134503 141.198830 103.771930 141.198830 
             17.672811 118.317972 14.723502 17.672811 
             27.514620 23.304094 86.929825 23.771930];
    obsx=[  106.889401 107.258065 141.912442 112.419355 
            85.994152 28.918129 55.584795 96.754386 
            112.419355 110.207373 91.774194 113.156682 
            93.947368 144.005848 113.596491 93.479532 ];     
    A = fscanf(myID,'%f',arena_size);  
...
%    program robot behaviors in this section    
    ...
    if ~avoiding;
        ...
        if sen_dist(5)<thresh % if danger is in front
            gas=700;          % reverse
            steer=2.1;          % dont steer 
            avoiding=2;      % for five seconds (iterations)   
        end
        
    else
        avoiding=avoiding-.5; %count down while 'avoiding the object'
    end
